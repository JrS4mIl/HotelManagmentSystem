...
SECRET_KEY = 'django-insecure--e18^fm=!6#4p9#i6**^d_u-bo)mt27i&uave)0#mjn_)vc7(4'
...
# Lokalizasyonu etkinleştir
USE_L10N = True

# Zaman dilimlerini etkinleştir
USE_TZ = True
...
# Çeviri dosyalarının bulunduğu dizinler
LOCALE_PATHS = [
    BASE_DIR / 'locale',
]
